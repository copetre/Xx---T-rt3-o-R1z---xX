...
class Matraque(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        # policier box
        self.currentSprite = pygame.transform.scale(pygame.image.load('assets/police_def_stick.png'), (160, 160))
        ...
        self.spritesWalkLeft = [pygame.transform.scale(pygame.image.load('assets/police_def_stick.png'), (160, 160)),
                                pygame.transform.scale(pygame.image.load('assets/police_walk_stick.png'), (160, 160))]
        ...
        self.damaged = False
        self.damagedFrame = 0
        self.spriteDeathLeft = pygame.transform.scale(pygame.image.load('assets/police_death_stick.png'), (160, 160))
        self.spriteDeathRight = pygame.transform.flip(self.spriteDeathLeft, True, False)

        # animation atk
        self.attacking = False
        self.attackFrame = 0
        self.spritesAttackLeft = [pygame.transform.scale(pygame.image.load('assets/police_attack1_stick.png'), (160, 160)),
                                  pygame.transform.scale(pygame.image.load('assets/police_attack2_stick.png'), (160, 160)),
                                  pygame.transform.scale(pygame.image.load('assets/police_attack1_stick.png'), (160, 160)),
                                  pygame.transform.scale(pygame.image.load('assets/police_def_stick.png'), (160, 160))]
