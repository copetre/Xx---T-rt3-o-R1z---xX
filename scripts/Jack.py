...
class Player(pygame.sprite.Sprite):
    def __init__(self, hud, game):
        ...
        # player box
        self.currentSprite = pygame.transform.scale(pygame.image.load('assets/jake_def.png'), (160, 160))
        ...
        self.soundHeartRecovery = pygame.mixer.Sound('sounds/HeartRecovery.ogg')
        self.soundMarcheJack = pygame.mixer.Sound('sounds/MarcheJack.ogg')
        self.soundJackSaut = pygame.mixer.Sound('sounds/JackSaut.ogg')
        self.soundJackAttaque = pygame.mixer.Sound('sounds/JackAttaqué.ogg')
        ...
        self.spritesWalkRight = [pygame.transform.scale(pygame.image.load('assets/jake_def.png'), (160, 160)),
                                 pygame.transform.scale(pygame.image.load('assets/jake_walk.png'), (160, 160))]
        ...
        self.damaged = False
        self.damagedFrame = 0
        self.spriteDeathRight = pygame.transform.scale(pygame.image.load('assets/jake_death.png'), (160, 160))
        self.spriteDeathLeft = pygame.transform.flip(self.spriteDeathRight, True, False)

        # animation atk
        self.attacking = False
        self.attackFrame = 0
        self.spritesAttackRight = [pygame.transform.scale(pygame.image.load('assets/jake_attack1.png'), (160, 160)),
                                   pygame.transform.scale(pygame.image.load('assets/jake_attack2.png'), (160, 160)),
                                   pygame.transform.scale(pygame.image.load('assets/jake_attack1.png'), (160, 160)),
                                   pygame.transform.scale(pygame.image.load('assets/jake_def.png'), (160, 160))]
