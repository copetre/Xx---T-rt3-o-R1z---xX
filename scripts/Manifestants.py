...
class Manifestant(pygame.sprite.Sprite):
    ...
    def __init__(self, game, type):
        ...
        # Type of manifestant
        if (type == 1):
            self.currentSprite = pygame.transform.scale(pygame.image.load('assets/mob_def_1.png'), (160, self.size))
        elif (type == 2):
            self.currentSprite = pygame.transform.scale(pygame.image.load('assets/mob_def_2.png'), (160, self.size))
        elif (type == 3):
            self.currentSprite = pygame.transform.scale(pygame.image.load('assets/mob_def_3.png'), (160, self.size))
        ...
        if (type == 1):
            self.spritesWalkLeft = [
                pygame.transform.scale(pygame.image.load('assets/mob_def_1.png'), (160, self.size)),
                pygame.transform.scale(pygame.image.load('assets/mob_walk_1.png'), (160, self.size))]
        elif (type == 2):
            self.spritesWalkLeft = [
                pygame.transform.scale(pygame.image.load('assets/mob_def_2.png'), (160, self.size)),
                pygame.transform.scale(pygame.image.load('assets/mob_walk_2.png'), (160, self.size))]
        elif (type == 3):
            self.spritesWalkLeft = [
                pygame.transform.scale(pygame.image.load('assets/mob_def_3.png'), (160, self.size)),
                pygame.transform.scale(pygame.image.load('assets/mob_walk_3.png'), (160, self.size))]
